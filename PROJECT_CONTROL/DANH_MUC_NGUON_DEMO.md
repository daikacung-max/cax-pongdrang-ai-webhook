# Danh mục nguồn tri thức demo

Ngày kiểm tra: 2026-09-05. Chỉ mục có trạng thái **Đang dùng** mới được phép làm căn cứ trả lời chi tiết. Trạng thái **Chờ nguồn** chỉ dùng để phân loại và hỏi dữ kiện, không dùng để tự tư vấn thủ tục.

| Nhóm tiếp nhận | Trạng thái | Nguồn chính thức / phạm vi |
|---|---|---|
| Căn cước dưới 14 tuổi | Đang dùng | Cổng DVC Bộ Công an, thủ tục 1.014062 |
| Căn cước cấp mới/đổi/cấp lại người từ 14 tuổi | Chờ nguồn | Cần tách đúng thủ tục theo độ tuổi và hình thức thực hiện |
...
| Mất giấy tờ hoặc tài sản | Chờ nguồn chi tiết | Chỉ tiếp nhận nhu cầu/chuyển cán bộ sau khi nguồn được duyệt |

Nguồn được thêm trong đợt này:
