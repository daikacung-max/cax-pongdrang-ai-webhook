...
# AI Core đầy đủ dùng 120B. Zalo Dynamic có cửa sổ phản hồi rất ngắn nên dùng 20B
# nhưng vẫn giữ nguyên retrieval + structured legal claims + verifier.
...
DYNAMIC_LEGAL_TOP_K = int(os.getenv("DYNAMIC_LEGAL_TOP_K", "3"))
